...
namespace Mathcontao\NGApacheFirewallForContao\ContaoManager;
...
class Plugin implements BundlePluginInterface, RoutingPluginInterface
{
    ...
    {
        return [
            BundleConfig::create('Mathcontao\NGApacheFirewallForContao\MathcontaoNGApacheFirewallForContao')
